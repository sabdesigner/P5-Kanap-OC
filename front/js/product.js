...
// Variable pour stocker l'Id des produits dans le tabl. product du LS
...
// Appel de la variable pour stocker les produits dans le stockage local en tant que chaîne JSON, lors de la récupération la verification sera faite par la fonction checkProduct
let productLocalStorage = JSON.parse(localStorage.getItem("cart")) || [];
// Fonction de verification des produits pour l'ajout au panier
